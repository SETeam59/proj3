...
def gits_sync(args):
	"""
	Function to sync local master with remote master and
	rebases the current branch with remote branch branch.
	Used when we want to go back to its stable state. 
	Function is similar to git sync
	"""
